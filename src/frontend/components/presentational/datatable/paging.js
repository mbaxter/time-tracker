    ...
    return (
        <div className="horizontal-spread">
            <div className="horizontal-spread">
                ...
                <div className="btn-group" role="group">
                    <button key="nextPage" className="btn btn-default btn-sm" disabled = {props.currentPage == props.totalPages}
                            onClick={() => props.onGoToPage(nextPage)} aria-label="Next Page">
                        Next <i className="fa fa-step-forward"/>
                    </button>
                    <button key="lastPage" className="btn btn-default btn-sm" disabled = {props.currentPage == props.totalPages}
