        ...
        <div className="horizontal-spread">
            <div className="horizontal-spread">
                <div className="btn-group" role="group">
                    <button key="firstPage" className="btn btn-default btn-xs" disabled = {props.currentPage == 1}
                            onClick={() => props.onGoToPage(1)} aria-label="First Page">
                        <i className="fa fa-fast-backward"/> First
                    </button>
                    <button key="previousPage" className="btn btn-default btn-xs" disabled = {props.currentPage == 1}
                ...
                <div className="btn-group" role="group">
                    <button key="nextPage" className="btn btn-default btn-xs" disabled = {props.currentPage == props.totalPages}
                            onClick={() => props.onGoToPage(nextPage)} aria-label="Next Page">
                        Next <i className="fa fa-step-forward"/>
                    </button>
                    <button key="lastPage" className="btn btn-default btn-xs" disabled = {props.currentPage == props.totalPages}
